FAKE_NET_COMMAND = "The request will be processed at a domain controller for domain <DOMAIN>\
...
FAKE_NET_COMMAND2 = "The request will be processed at a domain controller for domain <DOMAIN>\
...
FAKE_NET_COMMAND3 = "The request will be processed at a domain controller for domain <DOMAIN>\
...
FAKE_NET_COMMAND4 = "The request will be processed at a domain controller for domain <DOMAIN>\
    \n\n\n\nUser name FET7RT Full Name Fesseler Timo (EB-DB/ENG3)\n\
    Comment 208489\nUser's comment 4975140\nCountry/region code (null)\nAccount active Yes\n\
    Account expires 1/1/2022"

FAKE_NET_COMMAND5 = "The request will be processed at a domain controller for domain <DOMAIN>\
